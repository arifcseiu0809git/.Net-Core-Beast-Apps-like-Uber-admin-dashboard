...
public partial class DriverRideHistory: PageModel
{
	...
	private readonly ILogger<DriverRideHistory> _logger;
    private readonly IConfiguration _config;
    private readonly DriverModelService _DriverModelService;
    private readonly TripService _TripService;
	private readonly IWebHostEnvironment _hostEnvironment;

	public DriverRideHistory(ILogger<DriverRideHistory> logger, IConfiguration config, TripService TripService, DriverModelService DriverModelService, IWebHostEnvironment hostEnvironment)
    {
        this._logger = logger;
        this._config = config;
  ...
  //      return RedirectToPage("/Driver/DriverRideHistory", new { c = "Driver", p = false });
  //  });
